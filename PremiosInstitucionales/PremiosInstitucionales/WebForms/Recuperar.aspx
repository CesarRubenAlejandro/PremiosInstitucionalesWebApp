...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" Runat="Server">
    <div style="text-align:center">
        ...
        <asp:Label runat="server" ID="Info">Si tu cuenta de correo se encuentra registrada <br />
        ...
        <asp:HyperLink ID="HyperLink2" NavigateUrl="~/mm/Registro.aspx" runat="server">¿No tienes una cuenta? Regístrate</asp:HyperLink><br /><br />
