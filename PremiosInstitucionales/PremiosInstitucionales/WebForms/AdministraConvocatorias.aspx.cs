        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (premioActual != null)
                {
                    ...
                    {
                        avatarImage.Style.Add("background-image", "url(http://shashgrewal.com/wp-content/uploads/2015/05/default-placeholder.png)");
                    }
                        ...
                        Prueba.Controls.Add(new LiteralControl(
                            "<tr onclick=\"window.location.assign('AdministraCategorias.aspx?c=" + convocatoria.cveConvocatoria + "'); \">" +
                                "<td class=\"dt-profile-pic\">" +
                                     "<img src = \"http://inspired-bd.com/wp-content/uploads/2016/07/trophy200.png\" class=\"avatar img-circle\" alt=\"avatar\" style=\"max-width: 28px;\">" +
                                "</td>" +
