<%@ Page Title="" Language="C#" MasterPageFile="~/MP-Global.Master" AutoEventWireup="true" CodeBehind="AdministraAplicacionesPendientes.aspx.cs" Inherits="PremiosInstitucionales.WebForms.AdministraAplicacionesPendientes" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <script type="text/javascript">
        ...
        <div class="container fadeView">
            ...
            <div class="modal fade" id="modalAcceptApp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header text-center">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h3 class="modal-title" id="myModalLabel2">Aceptar aplicación</h3>
                            <hr class="shorthr"/>
                        </div>
                        <div class="modal-body">
