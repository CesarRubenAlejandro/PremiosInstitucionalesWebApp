        ...
        private string htmlProfilePicture()
        {
            ...
            if (Session[StringValues.RolSesion] != null)
            {
                if (Session[StringValues.RolSesion].ToString() == StringValues.RolCandidato)
                {
                    ...
                    htmlContent = "<a href=\"/Webforms/InformacionPersonalCandidato.aspx\" title=\""+ candidato.Nombre + " " + candidato.Apellido + "\">" + htmlContent + "</a>";
                    ...
                    if (candidato.NombreImagen != null && candidato.NombreImagen.Length > 0)
                    {
                        ...
                        {
                            htmlContent = "<a href=\"/Webforms/InformacionPersonalCandidato.aspx\" title=\"" + candidato.Nombre + " " + candidato.Apellido + "\">" +
                ...
                else if (Session[StringValues.RolSesion].ToString() == StringValues.RolJuez)
                {
                    ...
                    htmlContent = "<a href=\"/Webforms/InformacionPersonalJuez.aspx\" title=\"" + juez.Nombre + " " + juez.Apellido + "\">" + htmlContent + "</a>";
                    ...
                    if (juez.NombreImagen != null && juez.NombreImagen.Length > 0)
                    {
                        ...
                        {
                            htmlContent = "<a href=\"/Webforms/InformacionPersonalJuez.aspx\" title=\"" + juez.Nombre + " " + juez.Apellido + "\">" +
